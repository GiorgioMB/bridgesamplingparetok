...
.train_realnvp <- function(samples, normal_samples, num_coupling_layers = 5, epochs = 50, batch_size = length(samples), learning_rate = 0.001, train_ratio = 0.8, verbose = FALSE) {
  library(torch)
