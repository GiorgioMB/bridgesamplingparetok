...
bridge_sampler.CmdStanMCMC <- function(samples = NULL, repetitions = 1, method = "normal", cores = 1, keep_log_eval = FALSE, epochs = 50,
   ...
   bridge_out <- bridge_sampler.matrix(samples = draws, num_splits = num_splits, total_perms = total_perms,
                        ...
                        return_always = return_always, num_coupling_layers = num_coupling_layers,
                        lb = lb, ub = ub, repetitions = repetitions, epochs = epochs,
                        method = method, log_posterior = .cmdstan_log_posterior,
                        cores = cores, seed = seed, data = samples, learning_rate = learning_rate,
...
#' @rdname bridge_sampler
#' @export
bridge_sampler.stanfit <- function(samples = NULL, stanfit_model = samples, keep_log_eval = FALSE, epochs = 50,
                                      repetitions = 1, method = "normal", cores = 1, num_coupling_layers = 5,
                                      use_neff = TRUE, maxiter = 1000, silent = FALSE, num_splits = 2, learning_rate = 10e-4,
                                      total_perms = 1, verbose = FALSE, return_always = FALSE, seed = NA, pareto_smoothing_all = FALSE, pareto_smoothing_last = FALSE, ...) {
    ...
    if (cores == 1) {
      bridge_output <- do.call(what = paste0(".bridge.sampler.", method),
                               args = list(samples_4_fit = samples_4_fit,
                                           samples_4_iter = samples_4_iter, epochs = epochs,
                                           neff = neff, seed = seed, num_coupling_layers = num_coupling_layers,
                                           ...
                                           repetitions = repetitions, cores = cores, learning_rate = learning_rate,
      ...
      bridge_output <- do.call(what = paste0(".bridge.sampler.", method),
                               args = list(samples_4_fit = samples_4_fit,
                                           ...
                                           log_posterior = .stan_log_posterior, num_coupling_layers = num_coupling_layers,
                                           ...
                                           silent = silent, verbose = verbose, learning_rate = learning_rate,
                                           r0 = 0.5, tol1 = 1e-10, tol2 = 1e-4))
    }
...
bridge_sampler.mcmc.list <- function(samples = NULL, log_posterior = NULL, num_splits = 2, total_perms = 1, ..., data = NULL,
                                     lb = NULL, ub = NULL, repetitions = 1, pareto_smoothing_all = FALSE,
                                     param_types = rep("real", ncol(samples[[1]])), pareto_smoothing_last = FALSE,
                                     method = "normal", cores = 1, use_neff = TRUE, num_coupling_layers = 5,
                                     packages = NULL, varlist = NULL, envir = .GlobalEnv, epochs = 50,
                                     rcppFile = NULL, maxiter = 1000, silent = FALSE, learning_rate = 10e-4,
  ...
  for (perm in permutations) {
    ...
    bridge_output <- do.call(what = paste0(".bridge.sampler.", method),
                             args = list(samples_4_fit = samples_4_fit, seed = seed, epochs = epochs,
                                         samples_4_iter = samples_4_iter, pareto_smoothing_all = pareto_smoothing_all,
                                         neff = neff, log_posterior = log_posterior, num_coupling_layers = num_coupling_layers,
                                         ...
                                         param_types = param_types, learning_rate = learning_rate,
...
bridge_sampler.mcmc <- function(samples = NULL, log_posterior = NULL, ...,
                                ...
                                num_splits = 2, repetitions = 1, method = "normal", epochs = 50,
                                cores = 1, use_neff = TRUE, pareto_smoothing_last = FALSE,
                                packages = NULL, varlist = NULL, pareto_smoothing_all = FALSE,
                                envir = .GlobalEnv, rcppFile = NULL, num_coupling_layers = 5,
                                maxiter = 1000, return_always = FALSE, learning_rate = 10e-4,
  ...
  bridge_output <- bridge_sampler(samples = samples,
                                  ...
                                  repetitions = repetitions,pareto_smoothing_all = pareto_smoothing_all,
                                  method = method, pareto_smoothing_last = pareto_smoothing_last,
                                  cores = cores, use_neff = use_neff, epochs = epochs,
                                  packages = packages, varlist = varlist, num_coupling_layers = num_coupling_layers,
...
bridge_sampler.matrix <- function(samples = NULL, log_posterior = NULL, ..., num_splits = 2, total_perms = 1,
                                data = NULL, lb = NULL, ub = NULL, num_coupling_layers = 5,
                                repetitions = 1, method = "normal", epochs = 50,
                                cores = 1, use_neff = TRUE, pareto_smoothing_all = FALSE,
                                packages = NULL, varlist = NULL, pareto_smoothing_last = FALSE,
                                envir = .GlobalEnv, rcppFile = NULL, learning_rate = 10e-4,
  ...
  for (perm in permutations) {
     ...
     bridge_output <- do.call(what = paste0(".bridge.sampler.", method),
                    args = list(samples_4_fit = samples_4_fit,
                                ...
                                log_posterior = log_posterior, num_coupling_layers = num_coupling_layers,
                                "..." = ..., data = data,
...
bridge_sampler.stanreg <-
  function(samples, repetitions = 1, method = "normal", cores = 1, num_splits = 2, pareto_smoothing_all = FALSE, epochs = 50,
           use_neff = TRUE, maxiter = 1000, silent = FALSE, total_perms = 1, pareto_smoothing_last = FALSE, num_coupling_layers = 5,
           verbose = FALSE, return_always = FALSE, seed = NA, learning_rate = 10e-4, ...) {
    ...
    if (cores == 1) {
      bridge_output <- bridge_sampler(samples = samples, log_posterior = .stan_log_posterior, num_coupling_layers = num_coupling_layers, 
                                      ...
                                      use_neff = use_neff, packages = "rstan", total_perms = total_perms, epochs = epochs,
      ...
      bridge_output <- bridge_sampler(samples = samples,
                                      ...
                                      repetitions = repetitions, varlist = "stanfit", seed = seed, num_coupling_layers = num_coupling_layers, 
                                      envir = sys.frame(sys.nframe()), method = method, epochs = epochs, learning_rate = learning_rate,
...
#' @rdname bridge_sampler
#' @export
bridge_sampler.rjags <- function(samples = NULL, log_posterior = NULL, ..., data = NULL, num_splits = 2, learning_rate = 10e-4,
                                 total_perms = 1, lb = NULL, ub = NULL, repetitions = 1, num_coupling_layers = 5,
                                 method = "normal", cores = 1, use_neff = TRUE, pareto_smoothing_last = FALSE,
                                 packages = NULL, varlist = NULL, return_always = FALSE, epochs = 50,
  ...
  # run bridge sampling
  out <- bridge_sampler(samples = samples, log_posterior = log_posterior, num_splts = num_splits, epochs = epochs, learning_rate = learning_rate,
                        ...
                        use_neff = use_neff, packages = packages, varlist = varlist, envir = envir, num_coupling_layers = num_coupling_layers,
...
bridge_sampler.runjags <- function(samples = NULL, log_posterior = NULL, ..., data = NULL, num_splits = 2,
                                   ...
                                   envir = .GlobalEnv, rcppFile = NULL, seed = NA, epochs = 50, learning_rate = 10e-4,
                                   maxiter = 1000, silent = FALSE, verbose = FALSE) {
  ...
  out <- bridge_sampler(samples = samples, log_posterior = log_posterior, num_splits = num_splits, 
                        total_perms = total_perms, ..., return_always = return_always, epochs = epochs,
                        data = data, lb = lb, ub = ub, repetitions = repetitions, num_coupling_layers = num_coupling_layers,
                        ...
                        rcppFile = rcppFile, maxiter = maxiter, silent = silent, learning_rate = learning_rate,
...
bridge_sampler.MCMC_refClass <- function(samples,
                                  ...
                                  method = "normal", epochs = 50,
                                  cores = 1, pareto_smoothing_all = FALSE,
                                  use_neff = TRUE, num_coupling_layers = 5,
                                  maxiter = 1000, pareto_smoothing_last = FALSE,
                                  silent = FALSE, seed = NA, learning_rate = 10e-4,
  ...
  out <- bridge_sampler(samples = samples_mcmc_list, num_coupling_layers = num_coupling_layers,
                        log_posterior = log_posterior, num_splits = num_splits, total_perms = total_perms,
                        ..., pareto_smoothing_all = pareto_smoothing_all, pareto_smoothing_last = pareto_smoothing_last,
                        data = NULL, return_always = return_always, epochs = epochs, learning_rate = learning_rate,
